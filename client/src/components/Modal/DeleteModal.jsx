...
const DeleteModal = ({ closeModal, isOpen, handleDelete, roomId }) => {
    return (
        <Transition appear show={isOpen} as={Fragment}>
            ...
            {/* <div className='bg-red-500 w-96 h-96'>     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident ipsum aliquam, accusamus fuga laboriosam eius placeat consequuntur, autem iure, voluptatem architecto nulla tempora est incidunt alias labore nostrum reprehenderit natus.</div> */}
        </Transition>
    )
}
